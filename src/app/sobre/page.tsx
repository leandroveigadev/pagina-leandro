      ...
      <div className="w-full max-w-4xl flex flex-col gap-12 relative z-10">
        ...
        <div className="flex flex-col gap-4">
          ...
          <p className="text-zinc-400 text-lg leading-relaxed font-light">
            Olá! Leandro Veiga aqui, sou da área de engenharia de software e focado em construir sistemas que unem arquitetura robusta e performance impecável. Minha jornada é guiada pelo compromisso com o <strong className="text-zinc-200 font-semibold">Código limpo</strong>, arquitetura inteligente e pela busca de melhoria contínua, e que seja aplicável ao seu negócio.
          </p>
          <p className="text-zinc-400 text-base leading-relaxed font-light">
            Busco ser referência em ecossistemas de alta disponibilidade, atuo desde a modelagem de bancos de dados até a entrega final em produção, sempre garantindo escalabilidade e segurança. Acredito que um software bem escrito é o melhor investimento que uma empresa pode fazer.
          </p>
        </div>
